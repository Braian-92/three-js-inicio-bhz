...
<script type="importmap">
  {
    "imports": {
      ...
      "three/cannon/": "./cannon-es-master/examples/"
    }
  }
</script>
<!-- three-js-inicio-bhz/cannon-es-master/examples/js/smoothie.js -->
<script type="module">
  import * as THREE from 'three';
  import { OrbitControls } from 'three/addons/controls/OrbitControls.js';
  import { TransformControls } from 'three/addons/controls/TransformControls.js';
  import * as CANNON from 'three/addons/physics/cannon-es.js';
  import { SmoothieChart, TimeSeries } from 'three/cannon/js/smoothie.js';
  import { addTitle, addSourceButton } from 'three/cannon/js/dom-utils.js'
  import { bodyToMesh } from 'three/cannon/js/three-conversion-utils.js'
